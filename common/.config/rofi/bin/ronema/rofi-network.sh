...
function rofi_menu() {
    ...
    OPTIONS="${OPTIONS}${SELECTION_PREFIX}${SELECTION_HOTSPOT}\n"
...
function selection_action() {
    ...
    "${SELECTION_PREFIX}${SELECTION_HOTSPOT}") hotspot_management ;;
    "${SELECTION_PREFIX}${SELECTION_HOTSPOT_CREATE}") create_hotspot ;;
    "${SELECTION_PREFIX}${SELECTION_HOTSPOT_ON}") activate_hotspot ;;
    "${SELECTION_PREFIX}${SELECTION_HOTSPOT_OFF}") deactivate_hotspot ;;
    *)
